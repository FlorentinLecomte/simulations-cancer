...
%% cancer cells params
    ...
    hapto_L = 0.5;%0.1;      %maximum haptotaxis coefficient
    ...
    EMT_L = 1;    %maximum EMT coefficient
    EMT_slp = 1e+3;             
    ...
    MET_L = 1;    %maximum MET coefficient
    MET_slp =  1e+4;             
    MET_gf0 = 1e-2;   %decreasing with inflection at METgf0
...
%% ecm degradation
    ...
    degr_factor = 1e+2;             % (for the exponential; see reaction)

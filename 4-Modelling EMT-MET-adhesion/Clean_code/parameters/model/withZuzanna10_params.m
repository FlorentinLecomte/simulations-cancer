...
%% cancer cells params
    ...
    Dc_M = 1e-7;   %maximum diffusion coefficient
    Dc_sl = 20;    %maximum slope of the sigmoid wrt alpha
    Dc_a0 = 1;%0.5;   %sigmoid midpoint of the sigmoid wrt alpha

    % Haptotaxis: sigmoid (wrt a) function i.e. L/(1 + exp(-k(x-x_0)) )
    hapto_L = 4e-1;%0.1;      %maximum haptotaxis coefficient
    hapto_sl = 20;    %maximum slope of the logistic
    hapto_a0 = 1;%0.5;   %sigmoid midpoint
    ...
    EMT_slp = 10000;%30;             
    EMT_gf0 = 1e-2;   %increasing with inflection at EMTgf0
    ...
    MET_L = 200*EMT_L;    %maximum MET coefficient
    MET_slp =  EMT_slp;             
    ...
    prol_rate = 1e+0;%5;                
    prol_factor = 5;%5                    % (for the exponential; see reaction)

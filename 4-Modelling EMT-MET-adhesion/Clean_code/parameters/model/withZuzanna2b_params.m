...
%% cancer cells params
    ...
    Dc_M = 1e-5;%1e-8;   %maximum diffusion coefficient
    ...
    hapto_L = 0.1;%0.1;      %maximum haptotaxis coefficient
    ...
    EMT_L = 1e-3;    %maximum EMT coefficient
    EMT_slp = 30;             
    ...
    MET_L = 0.1*EMT_L;%0.1*EMT_L;    %maximum MET coefficient
    MET_slp =  EMT_slp;             
...
%% ecm degradation
    ecm_degr_rate = 0.2;%5;       % rate (check the paper for the proper coefficie)
